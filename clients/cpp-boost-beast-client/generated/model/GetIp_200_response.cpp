...
GetIp_200_response::GetIp_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GetIp_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GetIp_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GetIp_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GetIp_200_response::toJsonObject_internal() const
{
...
void GetIp_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_IpIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GetIp_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GetIp_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GetIp_200_response>>>::fromJsonValue(boost::json::parse(json));
}

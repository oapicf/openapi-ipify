...
DefaultApi::getIp(
    ...
    if (format) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "format",
            serializeQueryParameterValue(*format));
    }
    if (callback) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "callback",
            serializeQueryParameterValue(*callback));
    }
    path += queryParameterStream.str();

    std::string responseContentType = "application/json";
    static const std::vector<std::string> acceptTypes{ "text/plain","application/json","application/javascript", };

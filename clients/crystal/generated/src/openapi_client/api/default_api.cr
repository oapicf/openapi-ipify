...
module OpenAPIClient
  class DefaultApi
    ...
    # @return [String]
    def get_ip(format : String? = nil, callback : String? = nil)
    ...
    def get_ip_with_http_info(format : String? = nil, callback : String? = nil)
      ...
      header_params["Accept"] = @api_client.select_header_accept(["text/plain", "application/json", "application/javascript"])

...
```shell
gem install ./openapi_ipify-5.1.1-pre.0.gem
```

(for development, run `gem install --dev ./openapi_ipify-5.1.1-pre.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'openapi_ipify', '~> 5.1.1-pre.0'

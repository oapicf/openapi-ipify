...
allowed_methods(Req, #state{operation_id = 'getIp'} = State) ->
    {[<<"GET">>], Req, State};
...
content_types_accepted(Req, #state{operation_id = 'getIp'} = State) ->
    {[], Req, State};
...
valid_content_headers(Req, #state{operation_id = 'getIp'} = State) ->
    {true, Req, State};

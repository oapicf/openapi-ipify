...
void OAIDefaultApi::getIp(const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["getIp"][_serverIndices.value("getIp")].URL()+"/");
...
void OAIDefaultApi::getIpCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOneOfIpstring output(QString(worker->response));
    worker->deleteLater();

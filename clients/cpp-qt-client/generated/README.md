...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      connect(&apiInstance, &OAIDefaultApi::getIpSignalE, [&](QNetworkReply::NetworkError, const QString &error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString format = create(); // QString | Response format
      ...
      QString callback = create(); // QString | JSONP callback function name
      apiInstance.getIp(formatcallback);

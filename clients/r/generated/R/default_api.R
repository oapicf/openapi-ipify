...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return character
    GetIp = function(format = NULL, callback = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$GetIpWithHttpInfo(format, callback, data_file = data_file, ..., .parse = .parse)
    ...
    GetIpWithHttpInfo = function(format = NULL, callback = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_accepts <- list("text/plain", "application/json", "application/javascript")

...
- API version: 3.0.1-pre.0
  - Build date: 2022-08-10T13:01:11.927163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cliffano:openapiipify:3.0.1-pre.0"
  }
```
...
* `target/openapiipify-3.0.1-pre.0.jar`
* `target/lib/*.jar`

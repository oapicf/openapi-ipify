...
- API version: 3.2.2-pre.0
  - Build date: 2022-11-19T01:28:09.201064Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cliffano:openapiipify:3.2.2-pre.0"
  }
```
...
* `target/openapiipify-3.2.2-pre.0.jar`
* `target/lib/*.jar`

    ...
    B::Error: Into<Box<dyn Error + Send + Sync>>,
{
    ...
    async fn get_ip(
        &self,
        param_format: Option<models::GetIpFormatParameter>,
            ...
            200 => {
                ...
                let body = match content_type {
                    ...
                    Ok(ct) if ct.eq_ignore_ascii_case("application/json") => {
                        let body = str::from_utf8(&body)
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                        let body = serde_json::from_str::<models::GetIp200Response>(body)
                            .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;
                        swagger::OneOf3::<String, models::GetIp200Response, String>::B(body)
                    },
                    Ok(ct) if ct.eq_ignore_ascii_case("application/javascript") => {
                        let body = str::from_utf8(&body)
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                        let body = body.to_string();

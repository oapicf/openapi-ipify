...
OpenapiIpify - JavaScript client for openapi-ipify
...
```shell
npm install openapi-ipify --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your openapi-ipify from, and run:
...
```javascript
var OpenapiIpify = require('openapi-ipify');

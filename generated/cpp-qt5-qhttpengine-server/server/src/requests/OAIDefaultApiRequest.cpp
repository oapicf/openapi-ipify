...
void OAIDefaultApiRequest::getIpRequest(){
    qDebug() << "/";
    connect(this, &OAIDefaultApiRequest::getIp, handler, &OAIDefaultApiHandler::getIp);
...
void OAIDefaultApiRequest::getIpResponse(const OAIObject& res){
...
void OAIDefaultApiRequest::getIpError(const OAIObject& res, QNetworkReply::NetworkError error_type, QString& error_str){

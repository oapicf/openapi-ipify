...
module Openapi-ipify.Core where
...
-- | 
data Openapi-ipifyConfig = Openapi-ipifyConfig
...
-- | display the config
instance P.Show Openapi-ipifyConfig where
  show c =
    T.printf
...
-- | constructs a default Openapi-ipifyConfig
--
-- configHost:
--
-- @https://api.ipify.org@
...
-- configUserAgent:
--
-- @"openapi-ipify/0.1.0.0"@
--
newConfig :: IO Openapi-ipifyConfig
newConfig = do
    logCxt <- initLogContext
    return $ Openapi-ipifyConfig
        { configHost = "https://api.ipify.org"
        , configUserAgent = "openapi-ipify/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => Openapi-ipifyConfig -> auth -> Openapi-ipifyConfig
addAuthMethod config@Openapi-ipifyConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: Openapi-ipifyConfig -> IO Openapi-ipifyConfig
...
withStderrLogging :: Openapi-ipifyConfig -> IO Openapi-ipifyConfig
...
withNoLogging :: Openapi-ipifyConfig -> Openapi-ipifyConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * Openapi-ipifyRequest
...
data Openapi-ipifyRequest req contentType res accept = Openapi-ipifyRequest
  { rMethod  :: NH.Method   -- ^ Method of Openapi-ipifyRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of Openapi-ipifyRequest
  , rParams   :: Params -- ^ params of Openapi-ipifyRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (Openapi-ipifyRequest req contentType res accept) NH.Method
rMethodL f Openapi-ipifyRequest{..} = (\rMethod -> Openapi-ipifyRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (Openapi-ipifyRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f Openapi-ipifyRequest{..} = (\rUrlPath -> Openapi-ipifyRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (Openapi-ipifyRequest req contentType res accept) Params
rParamsL f Openapi-ipifyRequest{..} = (\rParams -> Openapi-ipifyRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (Openapi-ipifyRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f Openapi-ipifyRequest{..} = (\rAuthTypes -> Openapi-ipifyRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => Openapi-ipifyRequest req contentType res accept -> param -> Openapi-ipifyRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: Openapi-ipifyRequest req contentType res accept -> param -> Openapi-ipifyRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: Openapi-ipifyRequest req contentType res accept -> param -> Openapi-ipifyRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** Openapi-ipifyRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> Openapi-ipifyRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = Openapi-ipifyRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: Openapi-ipifyRequest req contentType res accept -> [NH.Header] -> Openapi-ipifyRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: Openapi-ipifyRequest req contentType res accept -> [NH.HeaderName] -> Openapi-ipifyRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => Openapi-ipifyRequest req contentType res accept -> Openapi-ipifyRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => Openapi-ipifyRequest req contentType res accept -> Openapi-ipifyRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: Openapi-ipifyRequest req contentType res accept -> [NH.QueryItem] -> Openapi-ipifyRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: Openapi-ipifyRequest req contentType res accept -> WH.Form -> Openapi-ipifyRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: Openapi-ipifyRequest req contentType res accept -> NH.Part -> Openapi-ipifyRequest req contentType res accept
...
_setBodyBS :: Openapi-ipifyRequest req contentType res accept -> B.ByteString -> Openapi-ipifyRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: Openapi-ipifyRequest req contentType res accept -> BL.ByteString -> Openapi-ipifyRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => Openapi-ipifyRequest req contentType res accept -> P.Proxy authMethod -> Openapi-ipifyRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: Openapi-ipifyConfig
    -> a
    -> Openapi-ipifyRequest req contentType res accept
    -> IO (Openapi-ipifyRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> Openapi-ipifyConfig
  -> IO (Openapi-ipifyRequest req contentType res accept)
_applyAuthMethods req config@(Openapi-ipifyConfig {configAuthMethods = as}) =
  foldlM go req as
  where

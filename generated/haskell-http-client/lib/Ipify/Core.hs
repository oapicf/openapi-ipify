...
-- | display the config
instance P.Show IpifyConfig where
  show c =
    T.printf
...
-- | constructs a default IpifyConfig
--
-- configHost:
--
-- @https://api.ipify.org@
...
-- @"ipify/0.1.0.0"@
--
newConfig :: IO IpifyConfig
newConfig = do
    logCxt <- initLogContext
    return $ IpifyConfig
        { configHost = "https://api.ipify.org"
        , configUserAgent = "ipify/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => IpifyConfig -> auth -> IpifyConfig
addAuthMethod config@IpifyConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: IpifyConfig -> IO IpifyConfig
...
withStderrLogging :: IpifyConfig -> IO IpifyConfig
...
withNoLogging :: IpifyConfig -> IpifyConfig
...
data IpifyRequest req contentType res accept = IpifyRequest
  { rMethod  :: NH.Method   -- ^ Method of IpifyRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of IpifyRequest
  , rParams   :: Params -- ^ params of IpifyRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (IpifyRequest req contentType res accept) NH.Method
rMethodL f IpifyRequest{..} = (\rMethod -> IpifyRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (IpifyRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f IpifyRequest{..} = (\rUrlPath -> IpifyRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (IpifyRequest req contentType res accept) Params
rParamsL f IpifyRequest{..} = (\rParams -> IpifyRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (IpifyRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f IpifyRequest{..} = (\rAuthTypes -> IpifyRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => IpifyRequest req contentType res accept -> param -> IpifyRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: IpifyRequest req contentType res accept -> param -> IpifyRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: IpifyRequest req contentType res accept -> param -> IpifyRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method 
          ...
          -> IpifyRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = IpifyRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: IpifyRequest req contentType res accept -> [NH.Header] -> IpifyRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: IpifyRequest req contentType res accept -> [NH.HeaderName] -> IpifyRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => IpifyRequest req contentType res accept -> IpifyRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => IpifyRequest req contentType res accept -> IpifyRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: IpifyRequest req contentType res accept -> [NH.QueryItem] -> IpifyRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: IpifyRequest req contentType res accept -> WH.Form -> IpifyRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: IpifyRequest req contentType res accept -> NH.Part -> IpifyRequest req contentType res accept
...
_setBodyBS :: IpifyRequest req contentType res accept -> B.ByteString -> IpifyRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: IpifyRequest req contentType res accept -> BL.ByteString -> IpifyRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => IpifyRequest req contentType res accept -> P.Proxy authMethod -> IpifyRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: IpifyConfig
    -> a
    -> IpifyRequest req contentType res accept
    -> IO (IpifyRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> IpifyConfig
  -> IO (IpifyRequest req contentType res accept)
_applyAuthMethods req config@(IpifyConfig {configAuthMethods = as}) =
  foldlM go req as
  where

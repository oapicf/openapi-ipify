...
export class DefaultService {
     ...
     */
    public getIp(format?: 'json' | 'jsonp', callback?: string, observe?: 'body', headers?: Headers): Observable<any>;
    public getIp(format?: 'json' | 'jsonp', callback?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public getIp(format?: 'json' | 'jsonp', callback?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.get(`${this.basePath}/?${queryParameters.join('&')}`, headers);
        if (observe == 'body') {

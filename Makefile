...
ci: clean deps init-spec generate build-javascript build-python-nextgen build-ruby test-javascript test-python-nextgen test-ruby doc
...
build-python-nextgen:
	sudo apt-get install -y python-setuptools
	pip install twine wheel
	cd clients/python-nextgen/generated/ && \
...
test-python-nextgen: build-python-nextgen
	cd clients/python-nextgen/generated/ && \
	  twine check dist/*
...
publish-python-nextgen: build-python-nextgen
	cd clients/python-nextgen/generated/ && \
	  twine upload dist/*
...
.PHONY: all test ci stage clean deps init-spec init-langs-config generate generate-all generate-primary build-javascript build-python-nextgen build-ruby test-javascript test-python-nextgen test-ruby publish-javascript publish-python-nextgen publish-ruby doc doc-latest doc-version doc-publish
